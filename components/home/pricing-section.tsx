        ...
        <div className="space-y-2 flex justify-center w-full">
          <Link
            ...
            className={cn(
              ...
              from-rose-800 to-rose-500 hover:from-rose-500 hover:to-rose-800 text-white
              border-2 py-2`,
              id === "pro"
                ? "border-rose-900"
  ...
  return (
    <section className="relative overflow-hidden" id="pricing">
      <div className="py-12 lg:py-24 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 lg:pt-12">
        ...
        <div
          className="relative flex justify-center flex-col lg:flex-row items-center lg:items-stretch
            gap-8"
        >
          {plans.map((plan) => (
